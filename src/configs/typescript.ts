  ...
  return [
    {
      ...
      name: 'shishuaiyun:typescript:setup',
      plugins: {
        antfu: pluginAntfu,
        import: pluginImport,
        ts: pluginTs as any,
    ...
    },
    {
      ...
      name: 'shishuaiyun:typescript:rules',
      rules: {
        ...renameRules(
    ...
    {
      files: ['**/*.d.ts'],
      name: 'shishuaiyun:typescript:dts-overrides',
      rules: {
    ...
    },
    {
      ...
      name: 'shishuaiyun:typescript:tests-overrides',
      rules: {
    ...
    {
      files: ['**/*.js', '**/*.cjs'],
      name: 'shishuaiyun:typescript:javascript-overrides',
      rules: {
